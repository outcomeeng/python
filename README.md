...
| `auditing-python` | auditing Python code or validating implementations |
| `auditing-python-architecture` | auditing ADRs or architecture decisions |
| `auditing-python-tests` | auditing Python tests for evidentiary value and spec compliance |
...
| `testing-python` | writing Python tests or fixing test failures |
